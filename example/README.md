...
go build -ldflags="-X github.com/hulto/packer-plugin-harvester/version.Version=0.2.3 -X github.com/hulto/packer-plugin-harvester/version.VersionPrerelease=dev" -o packer-plugin-harvester
