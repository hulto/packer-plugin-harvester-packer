...
type FlatConfig struct {
	...
	Kubeconfig                *string           `mapstructure:"kubeconfig" cty:"kubeconfig" hcl:"kubeconfig"`
	...
	NetworkNamespace          *string           `mapstructure:"network_namespace" cty:"network_namespace" hcl:"network_namespace"`
	ISOImageName              *string           `mapstructure:"iso_image_name" cty:"iso_image_name" hcl:"iso_image_name"`
	ISOImageNamespace         *string           `mapstructure:"iso_image_namespace" cty:"iso_image_namespace" hcl:"iso_image_namespace"`
	SourceImageName           *string           `mapstructure:"source_image_name" cty:"source_image_name" hcl:"source_image_name"`
	SourceImageNamespace      *string           `mapstructure:"source_image_namespace" cty:"source_image_namespace" hcl:"source_image_namespace"`
	OutputImageName           *string           `mapstructure:"output_image_name" cty:"output_image_name" hcl:"output_image_name"`
	OutputImageNamespace      *string           `mapstructure:"output_image_namespace" cty:"output_image_namespace" hcl:"output_image_namespace"`
...
func (*FlatConfig) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"kubeconfig":                   &hcldec.AttrSpec{Name: "kubeconfig", Type: cty.String, Required: false},
		...
		"network_namespace":            &hcldec.AttrSpec{Name: "network_namespace", Type: cty.String, Required: false},
		"iso_image_name":               &hcldec.AttrSpec{Name: "iso_image_name", Type: cty.String, Required: false},
		"iso_image_namespace":          &hcldec.AttrSpec{Name: "iso_image_namespace", Type: cty.String, Required: false},
		"source_image_name":            &hcldec.AttrSpec{Name: "source_image_name", Type: cty.String, Required: false},
		"source_image_namespace":       &hcldec.AttrSpec{Name: "source_image_namespace", Type: cty.String, Required: false},
		"output_image_name":            &hcldec.AttrSpec{Name: "output_image_name", Type: cty.String, Required: false},
		"output_image_namespace":       &hcldec.AttrSpec{Name: "output_image_namespace", Type: cty.String, Required: false},
